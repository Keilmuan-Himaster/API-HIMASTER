...
<div class="row">
   ...
   @include('backend.post.gallery._form')
</div>
@endsection
...
<script>
   ...
   function createItem() {
      setForm('create', 'POST', 'Add Gallery', true)
   }
   function editItem(id) {
      setForm('update', 'PUT', 'Edit Gallery', true)
      editData(id)
      // Toast.fire({
      //          icon: 'success',
...
<script>
   ...
   function setData(result) {
      ...
      $('input[name=structure_id]').val(result.structure_id);
